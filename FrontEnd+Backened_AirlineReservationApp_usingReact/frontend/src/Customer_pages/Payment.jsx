                ...
                axios.post(url2, arrayToBackend, ticketId).then(response => {
                    ...
                    if (result['status'] === 'success') {
                        ...
                        const mailBody = {
                            ...
                            message:
                            `
                            Train Name: ${trainDetails.dataofTrain.trainName}
                            Start City: ${trainDetails.dataofTrain.startCity}
                            Dest City: ${trainDetails.dataofTrain.destCity}
                        ...
                        navigate("/ticket", { state: { passList: array, trainData: trainDetails, ticketObj, fare } })
                    } else {
                        toast.error(result['error'])
                    }
                })
