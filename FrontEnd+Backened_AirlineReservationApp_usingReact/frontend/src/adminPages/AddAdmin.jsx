    ...
    return (
        <div className="container">
            ...
            <div className="mb-3">
                ...
                <button onClick={signupUser} style={{ marginTop: "10px", width:"150px",height:"40px", borderRadius:"50px" }} className="btn-primary">Submit</button>
                <button  onClick={cancel} style={{ marginTop: "10px", width:"150px",height:"40px",  borderRadius:"50px" }} className="btn-danger float-end">Cancel</button>
