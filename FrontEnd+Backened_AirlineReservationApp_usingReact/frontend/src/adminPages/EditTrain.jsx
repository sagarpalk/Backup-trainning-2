    ...
    return (
        <div className="container">
            ...
            <div className="form">
                ...
                <div>
                    <button style={{ marginTop: "10px", borderRadius: "30px", width: "200px", height: "40px" }} onClick={editHandler} className="btn-primary" >Edit Train</button>
                    <button style={{ marginTop: "10px", borderRadius: "30px", width: "200px", height: "40px" }} onClick={bhushan} className="btn-danger float-end">Cancel</button>
                </div>
